...
const SectionHeader = ({ title, count, action, onAction }) => (
  <div className="bg-gradient-to-r from-blue-700 to-blue-500 rounded-t-2xl px-5 py-3.5 flex items-center justify-between">
  ...
  return (
    <div className="mt-18 min-h-screen bg-slate-100 font-sans">
      ...
      <div className="px-8 pt-5 max-w-screen-xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <StatCard icon={Star}
          label="Rating"
          value={stats?.rating != null ? `${Number(stats.rating).toFixed(1)}★` : "4.6★"}
      ...
      <div className="px-8 pt-5 pb-14 max-w-screen-xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-6">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
            <div className="bg-gradient-to-br from-blue-800 to-blue-400 px-6 py-7 flex flex-col items-center gap-3">
            ...
            <div className="p-5 flex flex-col gap-2.5">
              {[
                ...
                { label: "Avg. Rating",     value: stats?.rating != null ? `${Number(stats.rating).toFixed(1)} / 5.0` : "4.6 / 5.0", icon: Star, color: "text-amber-500" },
